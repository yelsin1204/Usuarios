	...
	public function CrearfuncionarioC(){
		...
		if(isset($_FILES["foto"]["tmp_name"]) && !empty($_FILES["foto"]["tmp_name"])){ 
			...
			$datosC= array("rol" => $_POST["rolD"], "apellido" => $_POST["apellido"],"nombre" => $_POST["nombre"],
				...
				"telefono3" => $_POST["telefono3"],"correo" => $_POST["correo"],"correo2" => $_POST["correo2"],"institucion"  => $_POST["institucion"] ,
				"direccion"=>$_POST["direccion"], "foto"=>$rutaImg , "creado_por"=>$_POST["creado_por"],"nota"=>$_POST["nota"] ,"ciudad"=>$_POST["ciudad"],"dni"=>$_POST["dni"],
				"cv"=>$target_file,"cci"=>$_POST["cci"],"pasaporte"=>$_POST["pasaporte"]);  
...
//vizaulizar los camposs   ///
	...
	public function ActualizarfuncionarioC(){
		if(isset($_POST["Did"])){
			...
			$tablaBD = "consultores";
			$datosC = array("id"=>$_POST["Did"],"apellido"=>
			$_POST["apellidoE"],"nombre"=>$_POST["nombreE"],"cargo" =>
			 $_POST["cargoE"],"fecha"=>$_POST["fechaE"],"telefono"=>
			 $_POST["telefonoE"],"telefono2"=>$_POST["telefono2E"],"telefono3"=>$_POST["telefono3E"],
			 "correo"=>$_POST["correoE"] ,"correo2"=>$_POST["correo2E"],"institucion"=>$_POST["institucionE"] ,
			 "direccion"=>$_POST["direccionE"],"foto"=>$rutaImg, "creado_por"=>$_POST["creado_porE"],"cci"=>$_POST["cciE"],
			 "pasaporte"=>$_POST["pasaporteE"],
			 "nota"=>$_POST["notaE"],);  //trae el valor actual y lo reemplzas con el naem//
