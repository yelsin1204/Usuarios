          ...
          <?php
            ...
            foreach ($resultado as $key => $value) {
              ...
              <td>'.$value["descripcion"].'</td>
               <td>'.$value["nombre"].'-<a href="http://localhost/Usuarios/'.$value["archivos"].'"  download="'.$value["nombre"].'" <button >Descargar<i class="fa fa-download"></i></button></td>
...
<!-------////  EDITAR MODALLLL--  //-->
<div class="modal fade" rol="dialog" id="EditarArchivos">
  <div class="modal-dialog">
    <div class="modal-content">
      <form method="post" role="form" enctype="multipart/form-data">
        <div class="modal-header d-block bg-primary">
