 ...
 <center><img src="Vistas/img/forest 2.5.png"></center>
      ...
      <form method="post" >
        <div class="form-group has-feedback">
          <input type="text" name="usuario" class="form-control" placeholder="Usuario" style="border-radius: 20px" id="name">
          <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
        </div>
        <div class="form-group has-feedback">
          <input type="password" name="clave" class="form-control" placeholder="contraseña"  style="border-radius: 20px" id="clave">
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-xs-12">
            <button type="submit" class="btn-block btn btn-secondary" style="border-radius: 20px"  >INGRESAR</button>
