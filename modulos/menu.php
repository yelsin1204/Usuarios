...
if($_SESSION["rol"] == "administrador"){
      ...
      <li>
      <a href="http://localhost/Usuarios/carga">
    <i class="fa fa-upload"></i>
      <span>Carga masiva de archivos</span>
      </a>
      </li>
      ...
      <li>
       ...
       <li class="treeview">
        ...
        <ul class="treeview-menu">
          ...
          <li><a href="http://localhost/Usuarios/historias" ><i class="fa fa-circle-o"></i>Registro historico de contactos</a></li>
      </ul>
