					...
					<tbody>
						...
						foreach ($resultado as $key => $value) {
						  ...
						  <div class="btn-group">
							...
							<a target="" href="carta.php?id='.$value["id"].'" class="btn btn-warning" ><i class="fa fa-download"></i>Memo</a>
			...
			<form method="post" role="form"  enctype="multipart/form-data" id="tu-id">  <!--para poder cargar archivos-->
				...
				<div class="modal-body">
					<div class="box-body">
						...
						<div class="col-lg-5">
							<h4>cci</h4>
							<input type="text" class="form-control input-lg" name="cci" >
						</div>
						<div class="col-lg-5">
							<h4>pasaporte</h4>
							<input type="text" class="form-control input-lg" name="pasaporte" >
						</div>
			...
			<form method="post" role="form" enctype="multipart/form-data">
				...
				<div class="modal-body">
					<div class="box-body">
						...
						<div class="col-lg-5">
							<h4>cci</h4>
							<input type="text" class="form-control input-lg" name="cciE" id="cciE">
						</div>
						<div class="col-lg-5">
							<h4>pasaporte</h4>
							<input type="text" class="form-control input-lg" name="pasaporteE" id="pasaporteE">
						</div>

						<div class="col-lg-5">
							<h4>Curriculum Vitae</h4>
							<input type="file"   class="form-control input-lg" rows="3"  name="cvE" id="cvE" multiple="">
						</div class="col-lg-5">
