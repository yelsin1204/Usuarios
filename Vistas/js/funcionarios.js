...
$(".DT").on("click", ".EditarDoctor", function() {
    ...
    $.ajax({
        ...
        success: function(resultado) {
            ...
            //aca captamos la variable de los daotos del id de los consultores //
            // y con la variable resultado traemos el name de la bd//
            ...
            $("#cciE").val(resultado["cci"]);
            $("#pasaporteE").val(resultado["pasaporte"]);
